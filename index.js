...
const data = [
    { if : "오늘은 설레는 대학교 개강총회! 첫 눈에 반해버린 동기가 뒤풀이에 왔다! 이때 나는..?",
      q: "안녕하세요! 00학번 ㅇㅇㅇ입니다! <br/> 잘 부탁드립니다~!",
      a : [
...
function init () {
    ...
    questionItemLayout.innerHTML = data[index]["q"]//이미지가 없어져요 ->
    // div로 이미지와 텍스트 부분을 나눠야해요
...
function goToPage(event) {
    ...
    if(index===10){
        //윤제 친구 페이지로 보내주기
        //let score = Number(localStorage.getItem("score")); -> 이걸 이용해서 사용
